		...
		await addDoc(collection(db, "ThreeBank"), {
			...
			personalDetails: {
				...
				documents: {
					...
					// panCardUrl: panCardUrl || "https://brave.com/en-in/",
					// addressProofUrl:
					//     addressProofUrl || "https://brave.com/en-in/",
					// incomeProofUrl:
					//     incomeProofUrl || "https://brave.com/en-in/",
	...
	return (
		...
		>
			...
			>
				...
				>
					<Typography variant="h4">Complete your application</Typography>
				</Box>
				<Box
					sx={{
						display: "flex",
				...
				>
					...
					/>
					<Button onClick={() => incomeRef.current.click()} variant="contained">
						Income Proof
					</Button>
					<input
						ref={SignatureRef}
